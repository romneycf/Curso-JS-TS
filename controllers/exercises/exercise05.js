...
function handlePaginator(Recipes, itemsPerPage = 20, initalItem = 0, finalItem = 20) {
    console.log(Recipes);
...
// }
function renderRecipes(Recipes, splicedRecipes, itemsPerPage = 20, initalItem = 0, finalItem = 20) {
